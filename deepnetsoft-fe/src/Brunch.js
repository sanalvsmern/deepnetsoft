...
function Brunch() {
    ...
    const [key, setKey] = useState('brunch cocktails');
        ...
        <Container fluid>
            <Row>
                <Col md={12} className='selArea'>
                    ...
                    <button className='selBut1' onClick={() => navigate('/')}>DRINKS</button>
                    <button className='selBut2'>BRUNCH</button>
                </Col>
            </Row>
                    ...
                    <Row>
                        <Col md={12} className='contCol'>
                            <Row className='d-none d-lg-flex'>
                                <Col md={2}>
                                    <img src={`${process.env.PUBLIC_URL}/images/bru1.png`} className='bru1' alt="bru1" />
                                </Col>
                                ...
                                <Col md={1} className='d-flex align-items-center justify-content-flex-end'>
                                    <div className='contLine'></div>
                                </Col>
                            ...
                            <Row className='d-lg-none'>
                                <Col xs={2}>
                                    <img src={`${process.env.PUBLIC_URL}/images/bru1.png`} className='bru1a' alt="bru1" />
                                </Col>
                            ...
                            <Row className='d-none d-lg-flex'>
                                ...
                                <Col md={2} className='d-flex justify-content-end'>
                                    <img src={`${process.env.PUBLIC_URL}/images/bru2.png`} className='bru2' alt="bru2" />
                                </Col>
                            </Row>
                            <Row className='d-lg-none'>
                                <Col xs={2}>
                                ...
                                <Col xs={2} className='d-flex justify-content-end'>
                                    <img src={`${process.env.PUBLIC_URL}/images/bru2.png`} className='bru2a' alt="bru2" />
                                </Col>
                            </Row>
                        </Col>
